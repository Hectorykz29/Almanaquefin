...
<body>
     <div class="card-header border-0">
        <div class="row align-items-center">
          <div class="col">
            <h3 class="mb-0">Agenda febrero</h3>
          </div>
      ...
      <form action="{{ url('/febreros')}}" method="POST">
        @csrf
            ...
            <th scope="row">
             ...
             <td>
              <form action="{{ url('/febreros/'.$febrero->id)}}" method="POST">
                @csrf
                @method('DELETE')
                <a href="{{ url('/febreros/'.$febrero->id.'/edit')}}" class="btn btn-editar">Editar</a>
